...
# _C.MODEL.BB8KEYPOINT_OFFSET_ON = False
_C.MODEL.BB8KEYPOINT_ON = False
...
_C.MODEL.ROI_BB8KEYPOINT_HEAD = CN()
_C.MODEL.ROI_BB8KEYPOINT_HEAD.FEATURE_EXTRACTOR = "BB8KeypointRCNNFeatureExtractor"
_C.MODEL.ROI_BB8KEYPOINT_HEAD.PREDICTOR = "BB8KeypointRCNNPredictor"
_C.MODEL.ROI_BB8KEYPOINT_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_BB8KEYPOINT_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_BB8KEYPOINT_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_BB8KEYPOINT_HEAD.MLP_HEAD_DIM = 1024
_C.MODEL.ROI_BB8KEYPOINT_HEAD.CONV_LAYERS = tuple(512 for _ in range(8))
_C.MODEL.ROI_BB8KEYPOINT_HEAD.RESOLUTION = 14
_C.MODEL.ROI_BB8KEYPOINT_HEAD.NUM_CLASSES = 8
_C.MODEL.ROI_BB8KEYPOINT_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
