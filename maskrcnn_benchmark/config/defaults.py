...
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD = CN()
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.FEATURE_EXTRACTOR = "ResNet50Conv5ROIFeatureExtractor"
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.PREDICTOR = "FastRCNNPredictor"
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.NUM_CLASSES = 8
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
# Hidden layer dimension when using an MLP for the RoI box head
_C.MODEL.ROI_BB8KEYPOINT_OFFSET_HEAD.MLP_HEAD_DIM = 1024
