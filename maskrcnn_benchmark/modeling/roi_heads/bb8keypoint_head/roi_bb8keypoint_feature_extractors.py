...
@registry.ROI_BB8KEYPOINT_FEATURE_EXTRACTORS.register("BB8KeypointRCNNFeatureExtractor")
class BB8KeypointRCNNFeatureExtractor(nn.Module):
...
def make_roi_bb8keypoint_feature_extractor(cfg, in_channels):
    func = registry.ROI_BB8KEYPOINT_FEATURE_EXTRACTORS[
        cfg.MODEL.ROI_BB8KEYPOINT_HEAD.FEATURE_EXTRACTOR
    ]
